    ...
    test('stream with external handler', () async {
      ...
      final streamMearged = StreamMerged<double>([
        ...
        if (values[0] != null && values[1] != null && values[2] != null) {
          log(_debug, '${values[0]} * ${values[1]} - ${values[2]} = ', values[0]! * values[1]! - values[2]!);
          rightList.add(values[0]! * values[1]! - values[2]!);
          return values[0]! * values[1]! - values[2]!;
        }
        log(_debug, '${values[0]} * ${values[1]} - ${values[2]} = 0.0');
        rightList.add(0.0);
        return 0;
      },);      
      var done4 = false;
