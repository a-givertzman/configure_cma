...
import 'package:crane_monitoring_app/presentation/exhibit1/widgets/exhibit1_body.dart';
...
class Exhibit1Page extends StatefulWidget {
  ...
  State<Exhibit1Page> createState() => _ExhibitPageState(
    dsClient: _dsClient,
    users: _users,
...
class _ExhibitPageState extends State<Exhibit1Page> {
  ...
  Widget build(BuildContext context) {
    ...
    log(_debug, '[_ExhibitPageState.build] user: ', user);
  ...
  Widget _buildScaffold(BuildContext context) {
    ...
    const floatingActionButtonSize = AppUiSettings.floatingActionButtonSize;
    return WillPopScope(
          ...
          child: Scaffold(
            ...
            floatingActionButton: Padding(
              ...
              child: _buildMenuWidget(floatingActionButtonSize, context),
            ),
  ...
  Stack _buildMenuWidget(double floatingActionButtonSize, BuildContext context) {
    return Stack(
              children: [
                CircularFabWidget(
                  icon: Icon(Icons.menu, size: floatingActionButtonSize,),
                  // onPressed: () {
                  // },
                  children: [
                    FloatingActionButton(
                      heroTag: 'FloatingActionButtonHome', 
                      child: Icon(Icons.home, size: floatingActionButtonSize,),
                      onPressed: () {
                    ...
                    FloatingActionButton(
                      ...
                      child: Icon(Icons.color_lens_outlined, size: floatingActionButtonSize,),
                      onPressed: () {
                    ...
                    FloatingActionButton(
                      ...
                      child: Icon(Icons.account_circle_outlined, size: floatingActionButtonSize,),
                      onPressed: () {
                      },
                    ),
                    FloatingActionButton(
                      heroTag: 'FloatingActionButtonHomeLogout', 
                      child: Icon(Icons.logout, size: floatingActionButtonSize,),
                      onPressed: () {
                         _users.clear();
