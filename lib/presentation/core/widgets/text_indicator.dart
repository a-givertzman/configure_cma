...
class _TextIndicatorState extends State<TextIndicator> {
  ...
  Widget _buildValueText(BuildContext context, AsyncSnapshot<DsDataPoint<num>> snapshot) {
    ...
    if (snapshot.hasError) {
      ...
      log(_debug, '[$_TextIndicatorState._buildValueText] snapshot.error: ', snapshot.error);
      ...
      if (point != null) {
        ...
        log(_debug, '[$_TextIndicatorState._build] snapshot.connectionState: ', snapshot.connectionState);
      }
    } else {
      log(_debug, '[$_TextIndicatorState._build] snapshot.connectionState: ', snapshot.connectionState);
    }
