    ...
    return StreamBuilder<DsDataPoint<num>>(
      ...
      builder: (context, snapshot) {
        ...
        if (snapshot.hasError) {
          ...
          log(CircularBarIndicator._debug, '[$CircularBarIndicator.build] error: ${snapshot.error}');
        } else if (snapshot.hasData) {
          final dataPoint = snapshot.data;
          // log(CircularBarIndicator._debug, '[$CircularBarIndicator.build] dataPoint: $dataPoint');
          if (dataPoint != null) {
